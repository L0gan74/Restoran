    ...
    <div className="delievery-basket_card">
      ...
      <div className="delievery-basket_card-right">
        ...
        <div className="delievery-basket_card-amount">
          <button onClick={onClickPlus} className="delievery-basket_card-amount_add" type="button">
            <img src={plus} />
          </button>
          <p>{count}</p>
          <button onClick={onClickMinus} className="delievery-basket_card-amount_down" type="button">
            <img src={minus} />
          </button>
        </div>
